...
var AbstractHashRouter = /** @class */ (function () {
    ...
    AbstractHashRouter.prototype.handleEvent = function (_) {
        var _this = this;
        var _a = (0, exports.takeHash)(this.window), path = _a[0], query = _a[1];
        var cache = this.cache;
        var mware = [];
        var handler = function () { return (0, future_1.pure)(undefined); };
        var keys = [];
        var r = null;
        var count = 0;
        ...
        if (r != null) {
            ...
            mware
                ...
                .chain(handler)
                .trap(function (e) { return _this.onError(e); })
    ...
    AbstractHashRouter.prototype.use = function (path, mware) {
        if (this.routes.hasOwnProperty(path)) {
            ...
            this.routes[path] = [[mware], function () { return (0, future_1.pure)(undefined); }];
        }
        this.cache = (0, exports.compile)(this.routes);
        return this;
    };
...
var HashRouter = /** @class */ (function (_super) {
    ...
    function HashRouter(window, routes, error, notFound) {
        if (routes === void 0) { routes = {}; }
        if (error === void 0) { error = function (e) { return (0, future_1.raise)(e); }; }
        if (notFound === void 0) { notFound = function () { return (0, future_1.pure)((0, function_1.noop)()); }; }
...
var compile = function (r) {
    return (0, record_1.reduce)(r, [], function (p, c, path) {
        var keys = [];
